...
class RGB():
    def __init__(self, image1, image2, image3, 
                 ...
                 norm = 'linear', gamma = 1, blur = False):
        '''
        ...
        # image1 = image1
        image2 = self.register(image2, image1)
        image3 = self.register(image3, image1)
        
        if blur:
            self.image1 = gaussian_filter(image1, sigma=blur)
            self.image2 = gaussian_filter(image2, sigma=blur)
            self.image3 = gaussian_filter(image3, sigma=blur)
